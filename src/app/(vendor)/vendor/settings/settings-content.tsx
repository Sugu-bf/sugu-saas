...
import { Toggle, PillInput, PillSelect, PillButton, SectionCard, Field } from "@/components/shared/settings-ui";
...
export function SettingsPageClient() {
  ...
  if (isLoading) {
    return <SettingsLoadingSkeleton navItemCount={10} />;
  }
...
export function SettingsContent({ data }: { data: VendorSettings }) {
  ...
  /** Save profile tab: calls identity + contact + profile mutations in parallel */
  ...
  return (
    <>
      <SettingsShell
        ...
        badgeInactiveClass="bg-red-100 text-red-600 dark:bg-red-950/50 dark:text-red-400"
        headerAction={
