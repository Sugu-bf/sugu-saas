...
export default function DriverDeliveriesError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("[Driver Livraisons] page error:", error);
  }, [error]);
    ...
    <div className="flex min-h-[40vh] flex-col items-center justify-center gap-6 text-center">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
          Une erreur est survenue lors du chargement de vos livraisons.
        </p>
      </div>
      <button
        onClick={reset}
