...
export function TabDeleteAccount() {
  ...
  const deleteAccountMutation = useDeleteDriverAccount();
  ...
  return (
    <div className="space-y-6">
      <SectionCard title="Supprimer mon compte" id="delete-account" variant="danger" className="animate-card-enter">
        <div className="mt-4 flex flex-col items-center text-center">
          ...
          <p className="mx-auto mt-2 max-w-lg text-sm text-gray-600 dark:text-gray-400">
            ...
            Toutes vos données, historique de livraisons, gains, et documents KYC seront définitivement supprimés.
          </p>
        </div>
